...
### 2026-07-28 (4 篇)
- [x] agiletec-inc/airis-mcp-gateway · ⭐151 · NLPM 90/100 · upstream（SECURITY BLOCKED—3×Critical curl|bash+shell injection，90/100 NL 高分但安全红线；4 skill 全无 examples；install.sh curl|bash 持续，VERSION=latest 持续；routing-table.json config 驱动新增） · [案例](2026-07/2026-07-28-agiletec-inc-airis-mcp-gateway.md)
- [x] affaan-m/everything-claude-code · ⭐0 · NLPM 84/100 · upstream（SECURITY BLOCKED，934 个工件迄今最大，install.sh 已重写为 Node.js 委托，the-security-guide.md 新增，前 94 个 command 已补 frontmatter；GAN 式自进化架构） · [案例](2026-07/2026-07-28-affaan-m-everything-claude-code.md)
- [x] agent-sh/enhance · ⭐3 · NLPM 86/100 · upstream（SECURITY CLEAR，NL+原生二进制核心架构，enhance.md frontmatter 已修，version 漂移 5.1.0 vs 1.0.0 持续，8 个 agent 零 examples 持续） · [案例](2026-07/2026-07-28-agent-sh-enhance.md)
- [x] aaronmaturen/claude-plugin · ⭐1 · NLPM 36/100 · upstream（SECURITY REVIEW，26 个 command 全部缺 frontmatter—3 个月后仍未修，Context7 MCP npx -y 未固定，JIRA 集成+$REPORT_BASE 约定有价值） · [案例](2026-07/2026-07-28-aaronmaturen-claude-plugin.md)
...
- ~~aaronmaturen/claude-plugin · ⭐1~~ → 已完成（2026-07-28，<500 但≥500池耗尽后最具工程对比价值）
- ~~agent-sh/agnix · ⭐207~~ → 已完成（2026-07-25，<500 但≥500池耗尽后最接近门槛）
- ~~agent-sh/enhance · ⭐3~~ → 已完成（2026-07-28，<500 但≥500池耗尽后最具工程对比价值）
- ~~agiletec-inc/airis-mcp-gateway · ⭐151~~ → 已完成（2026-07-28，<500 但≥500池耗尽后最具工程对比价值）
