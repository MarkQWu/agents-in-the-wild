...
|---|---|---|---|---|---|
| jnuyens/gsd-plugin | ⭐9 | 90.3/100 | upstream（SECURITY CLEAR，0/33 agents 声明 model 持续；PostToolUse hook 已修（Edit|Write only）；gsd-advisor-researcher 零示例持续；有状态工作流+全覆盖 hook 监控架构，hooks.json 大幅演进） | 2026-07-31 | [2026-07/2026-07-31-jnuyens-gsd-plugin.md](2026-07/2026-07-31-jnuyens-gsd-plugin.md) |
| c0x12c/ai-toolkit | ⭐61 | 96/100 | upstream（SECURITY UNKNOWN，BUG-1 已修（tools: 字段删除），BUG-2 terraform-best-practices 持续，M-3 GSD pack 已删（v1.24.0 BREAKING），25→61 commands 全部缺 allowed-tools；单一来源+自动多目标镜像架构） | 2026-07-31 | [2026-07/2026-07-31-c0x12c-ai-toolkit.md](2026-07/2026-07-31-c0x12c-ai-toolkit.md) |
| kangraemin/claude-inspector | ⭐115 | 76/100 | upstream（SECURITY REVIEW，3 bug 全部持续：proxy-analyzer/reviewer/ui-debugger 缺 name: 字段；PR #2/#3/#4 开放 ~100 天；3 skills 100/100 vs 3 agents 43-55/100 极端不对称；Electron NL 表皮架构） | 2026-07-31 | [2026-07/2026-07-31-kangraemin-claude-inspector.md](2026-07/2026-07-31-kangraemin-claude-inspector.md) |
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED，curl\|bash 在 install.sh:6/266 + quick-install.sh:6 持续；4 skills 零示例持续；最小 NL 表皮+重型原生后端架构；日语 CLAUDE.md "推测不到的边界" 模式可借鉴） | 2026-07-31 | [2026-07/2026-07-31-agiletec-inc-airis-mcp-gateway.md](2026-07/2026-07-31-agiletec-inc-airis-mcp-gateway.md) |
