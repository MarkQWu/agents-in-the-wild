...
|---|---|---|---|---|---|
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED—3×Critical curl\|bash+shell injection，90/100 NL 高分但安全红线；4 skill 全无 examples；install.sh curl\|bash 持续，VERSION=latest 持续） | 2026-07-28 | [2026-07/2026-07-28-agiletec-inc-airis-mcp-gateway.md](2026-07/2026-07-28-agiletec-inc-airis-mcp-gateway.md) |
| affaan-m/everything-claude-code | ⭐0 | 84/100 | upstream（SECURITY BLOCKED，934 个工件迄今最大，install.sh 已重写为 Node.js 委托，the-security-guide.md 新增，前 94 个 command 已补 frontmatter） | 2026-07-28 | [2026-07/2026-07-28-affaan-m-everything-claude-code.md](2026-07/2026-07-28-affaan-m-everything-claude-code.md) |
| agent-sh/enhance | ⭐3 | 86/100 | upstream（SECURITY CLEAR，NL+原生二进制核心架构，enhance.md frontmatter 已修，version 漂移 5.1.0 vs 1.0.0 持续，8 个 agent 零 examples 持续） | 2026-07-28 | [2026-07/2026-07-28-agent-sh-enhance.md](2026-07/2026-07-28-agent-sh-enhance.md) |
| aaronmaturen/claude-plugin | ⭐1 | 36/100 | upstream（SECURITY REVIEW，26 个 command 全部缺 frontmatter—3 个月后仍未修，Context7 MCP npx -y 未固定，JIRA 集成+$REPORT_BASE 约定有价值） | 2026-07-28 | [2026-07/2026-07-28-aaronmaturen-claude-plugin.md](2026-07/2026-07-28-aaronmaturen-claude-plugin.md) |
