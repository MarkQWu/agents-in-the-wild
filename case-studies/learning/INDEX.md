...
|---|---|---|---|---|---|
| navapbc/digital-service-orchestra | ⭐3 | 84.8/100 | upstream（SECURITY PASS，bot-psychologist taxonomy 17→16 不一致持续；agents 从 31 暴增到 63；DSO v1.16.11 双渠道发布；Router+agent 矩阵+JSON schema 通信架构） | 2026-07-29 | [2026-07/2026-07-29-navapbc-digital-service-orchestra.md](2026-07/2026-07-29-navapbc-digital-service-orchestra.md) |
| c0x12c/ai-toolkit | ⭐61 | 96/100 | upstream（SECURITY REVIEW，allowed-tools 全 69 命令缺失持续，phase-reviewer Bash 未声明持续，guard 无空值处理持续；v1.22.1→v1.27.0 活跃迭代；Spartan GSD 路由器+角色化 agent 架构） | 2026-07-29 | [2026-07/2026-07-29-c0x12c-ai-toolkit.md](2026-07/2026-07-29-c0x12c-ai-toolkit.md) |
| kangraemin/claude-inspector | ⭐115 | 76/100 | upstream（SECURITY REVIEW，3 个 agent 全部缺 name 字段持续导致无法注册，review-rules.md 外部引用持续；3 个 skill 100/100 完美；静默失效陷阱案例） | 2026-07-29 | [2026-07/2026-07-29-kangraemin-claude-inspector.md](2026-07/2026-07-29-kangraemin-claude-inspector.md) |
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED，curl\|bash 3 处 Critical 持续，shell 注入 Medium 持续，4 个 skill 零示例持续；MCP 按需启动架构；CLAUDE.md 禁止区模式值得借鉴） | 2026-07-29 | [2026-07/2026-07-29-agiletec-inc-airis-mcp-gateway.md](2026-07/2026-07-29-agiletec-inc-airis-mcp-gateway.md) |
