...
|---|---|---|---|---|---|
| jnuyens/gsd-plugin | ⭐9 | 90.3/100 | upstream（SECURITY CLEAR，0/33 agents 零 model 声明持续，vague quantifiers 系统性分布，生产者/消费者无 schema；v2.38.8→v4.4.0 大版本升级，schema/handoff-v1.json 新增，worktree-path-safety.md 新增；MCP 状态机+三层编排架构） | 2026-07-27 | [2026-07/2026-07-27-jnuyens-gsd-plugin.md](2026-07/2026-07-27-jnuyens-gsd-plugin.md) |
| c0x12c/ai-toolkit | ⭐61 | 96/100 | upstream（SECURITY REVIEW→Medium 3 个，66 commands 全无 allowed-tools 系统性持续，BUG-1 phase-reviewer 无 Bash 持续；v1.22.1→v1.27.0，bridges/telegram 新增，命令数从 25→69；Spartan 纪律+命令路由+专家 Agent 架构） | 2026-07-27 | [2026-07/2026-07-27-c0x12c-ai-toolkit.md](2026-07/2026-07-27-c0x12c-ai-toolkit.md) |
| kangraemin/claude-inspector | ⭐115 | 76/100 | upstream（SECURITY REVIEW→Medium 2 个，3 agents 全无 name 字段持续，reviewer 孤引用 ~/.claude/rules/review-rules.md 持续；Homebrew Cask 分发新增，截图国际化；NL 表皮+Electron 原生核心架构） | 2026-07-27 | [2026-07/2026-07-27-kangraemin-claude-inspector.md](2026-07/2026-07-27-kangraemin-claude-inspector.md) |
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED→CRITICAL curl\|bash×3+HIGH shell injection 全部持续；4 skills 零 examples 持续；routing-table.json 外部化新增，COLD_TOOLS_IN_LIST=false 降级模式新增；MCP 路由网关+NL 配置复印架构） | 2026-07-27 | [2026-07/2026-07-27-agiletec-inc-airis-mcp-gateway.md](2026-07/2026-07-27-agiletec-inc-airis-mcp-gateway.md) |
