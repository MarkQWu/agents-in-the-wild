...
| aaronmaturen/claude-plugin | ⭐1 | 36/100 | upstream（SECURITY REVIEW，contributed，14/26 commands 已补 frontmatter，context7 pin 未修；任务矩阵+双 skill 模式，bureau commands 缺 name+allowed-tools 同类问题） | 2026-07-30 | [2026-07/2026-07-30-aaronmaturen-claude-plugin.md](2026-07/2026-07-30-aaronmaturen-claude-plugin.md) |
| affaan-m/everything-claude-code | ⭐N/A | 84/100 | upstream（SECURITY BLOCKED→hooks CRITICAL 已修，learn.md frontmatter 已修；934 工件，281 skills，67 agents；超级插件+多运行时适配器+本地化镜像架构） | 2026-07-30 | [2026-07/2026-07-30-affaan-m-everything-claude-code.md](2026-07/2026-07-30-affaan-m-everything-claude-code.md) |
| agent-sh/enhance | ⭐3 | 86/100 | upstream（SECURITY CLEAR，enhance.md allowed-tools 已修，version mismatch 5.1.0 vs 1.0.0 未修，8 agents 零示例持续；单入口+并行专家 agent+知识下沉 skill 模式，agent-knowledge/ 跨会话学习） | 2026-07-30 | [2026-07/2026-07-30-agent-sh-enhance.md](2026-07/2026-07-30-agent-sh-enhance.md) |
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED，3 Critical curl\|bash 未修，4 skills 零示例，AIRIS_VERSION=latest 未修；Bash(task *) 权限最小化+capability-router 路由模式，配置契约测试新增） | 2026-07-30 | [2026-07/2026-07-30-agiletec-inc-airis-mcp-gateway.md](2026-07/2026-07-30-agiletec-inc-airis-mcp-gateway.md) |
