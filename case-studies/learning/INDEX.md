...
|---|---|---|---|---|---|
| gadievron/raptor | ⭐N/A | 93/100 | upstream（SECURITY BLOCKED→部分修复，curl\|bash 改为 capture-then-execute 无 checksum；BUG-1 SecOpsAgentKit 空占位符持续，BUG-2/3 CLAUDE.md 名称漂移持续，BUG-4 tools 字段缺失持续；commands 从 21 扩展至 35；专域 agent 网格架构） | 2026-08-04 | [2026-08/2026-08-04-gadievron-raptor.md](2026-08/2026-08-04-gadievron-raptor.md) |
| jnuyens/gsd-plugin | ⭐9 | 90.3/100 | upstream（SECURITY CLEAR，Q-01 model 字段全 0/33 持续，Q-02 3 agents 零示例持续，Q-04 9 thin skills 持续；hooks 重构为 coexistence election + 8 detector 文件；状态文件驱动编排架构，skills 82→90，VERSION 2.38.8→2.45.0） | 2026-08-04 | [2026-08/2026-08-04-jnuyens-gsd-plugin.md](2026-08/2026-08-04-jnuyens-gsd-plugin.md) |
| thedotmack/claude-mem | ⭐N/A | 97/100 | upstream（SECURITY BLOCKED→smart-install.js 已删除，openclaw curl\|bash 持续；BUG-1/2/3/4 frontmatter 缺失持续，BUG-5 版本漂移已修；NL 表皮+TypeScript 二进制核心架构；skills 6→19，VERSION 11.0.1→13.13.1） | 2026-08-04 | [2026-08/2026-08-04-thedotmack-claude-mem.md](2026-08/2026-08-04-thedotmack-claude-mem.md) |
| c0x12c/ai-toolkit | ⭐61 | 96/100 | upstream（SECURITY CLEAR，BUG-1 shell commands without Bash tool 持续，BUG-2 terraform skills allowed_tools 持续，Q-1 commands allowed-tools 5/70 部分修复；compiled mirror 架构 toolkit/→.codex/；commands 25→70，VERSION 1.22.1→1.27.0） | 2026-08-04 | [2026-08/2026-08-04-c0x12c-ai-toolkit.md](2026-08/2026-08-04-c0x12c-ai-toolkit.md) |
| aaronmaturen/claude-plugin | ⭐1 | 36/100 | upstream（SECURITY REVIEW，26/26 commands 缺 frontmatter 已部分修复→12 个仍缺，Context7 MCP 版本未固定持续，调用示例 /atm-scaffold 格式漂移持续；专业命令平铺集架构，Angular/Django 全栈工具箱） | 2026-08-06 | [2026-08/2026-08-06-aaronmaturen-claude-plugin.md](2026-08/2026-08-06-aaronmaturen-claude-plugin.md) |
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED，3 CRITICAL curl\|bash 持续，shell injection 持续；4 MCP skill 零示例持续，troubleshoot.md ARGUMENTS 空值保护持续；NL 表皮+原生代码核心架构，MCP 网关统一入口） | 2026-08-06 | [2026-08/2026-08-06-agiletec-inc-airis-mcp-gateway.md](2026-08/2026-08-06-agiletec-inc-airis-mcp-gateway.md) |
| navapbc/digital-service-orchestra | ⭐3 | 84.8/100（plugin） | upstream（SECURITY PASS，dispatch shim 23→0 全部删除，agents 31→53，skills 32→38；commit.md/review.md 零frontmatter 持续，skill model 声明 2/38；专家 Agent 网格+仲裁层架构，v1.17.149） | 2026-08-06 | [2026-08/2026-08-06-navapbc-digital-service-orchestra.md](2026-08/2026-08-06-navapbc-digital-service-orchestra.md) |
| alirezarezvani/claude-skills | ⭐N/A | 92/100 | upstream（SECURITY BLOCKED，openclaw curl\|bash 持续，5 HIGH subprocess shell=True 持续；playwright-pro 子skill frontmatter 7/7 持续，wiki agents Write/Edit 权限 3/3 持续；多域 Skill 聚合库架构，431 工件） | 2026-08-06 | [2026-08/2026-08-06-alirezarezvani-claude-skills.md](2026-08/2026-08-06-alirezarezvani-claude-skills.md) |
...
| memvid/claude-brain | ⭐465 | 96/100 | upstream（SECURITY BLOCKED，HIGH shell injection in recent.md，全部 3 bug 持续：search limit 硬编码、.mind.mv2 typo、memory/mind 重复 skill；hooks 生命周期设计值得借鉴） | 2026-07-24 | [2026-07/2026-07-24-memvid-claude-brain.md](2026-07/2026-07-24-memvid-claude-brain.md) |
| levnikolaevich/claude-code-skills | ⭐423 | 77/100 | upstream（SECURITY BLOCKED，CRITICAL eval "$cmd"；288 artifacts→21 MD files 架构大重组；skills-catalog 全部删除；Codex 适配器模式彻底废弃） | 2026-07-24 | [2026-07/2026-07-24-levnikolaevich-claude-code-skills.md](2026-07/2026-07-24-levnikolaevich-claude-code-skills.md) |
| josstei/maestro-orchestrate | ⭐370 | 87/100 | upstream（SECURITY BLOCKED，prepare 脚本已修复，3 HIGH 其余持续；25 MCP 存根 score 75，Output Contract 模糊词扩散，75 agent 无 model；多运行时适配器+分层质量梯度架构） | 2026-07-24 | [2026-07/2026-07-24-josstei-maestro-orchestrate.md](2026-07/2026-07-24-josstei-maestro-orchestrate.md) |
| peterfei/ai-agent-team | ⭐336 | 82/100 | upstream（SECURITY BLOCKED，CRITICAL curl\|bash，HIGH SQL注入；3 bug 全部持续（tech_leader下划线×2、thread-manager无frontmatter）；v2.1.0新增fullstack角色；中文量词 清晰/全面/合理 问题） | 2026-07-24 | [2026-07/2026-07-24-peterfei-ai-agent-team.md](2026-07/2026-07-24-peterfei-ai-agent-team.md) |
