...
| agiletec-inc/airis-mcp-gateway | ⭐151 | 90/100 | upstream（SECURITY BLOCKED，3 CRITICAL curl\|bash+shell injection；skills/包架构整体移除；curl\|bash+shell injection持续；日文CLAUDE.md边界清单模式值得借鉴；NL薄皮+Shell厚核架构） | 2026-08-01 | [2026-08/2026-08-01-agiletec-inc-airis-mcp-gateway.md](2026-08/2026-08-01-agiletec-inc-airis-mcp-gateway.md) |
| kangraemin/claude-inspector | ⭐115 | 76/100 | upstream（SECURITY REVIEW，3 agent 全部缺 name 字段持续，review-rules.md 孤儿引用持续；skills 100/100 vs agents 47.7/100 极端分化；韩文开发，Electron+Playwright桌面调试架构） | 2026-08-01 | [2026-08/2026-08-01-kangraemin-claude-inspector.md](2026-08/2026-08-01-kangraemin-claude-inspector.md) |
| c0x12c/ai-toolkit | ⭐61 | 96/100 | upstream（SECURITY CLEAR，phase-reviewer 新增 model+examples 改善，62 commands 仍缺 allowed-tools，terraform-best-practices 仍缺 allowed_tools；双目录镜像发布架构；skills 98.6/100 Gotchas段落标准化） | 2026-08-01 | [2026-08/2026-08-01-c0x12c-ai-toolkit.md](2026-08/2026-08-01-c0x12c-ai-toolkit.md) |
| jnuyens/gsd-plugin | ⭐9 | 90/100 | upstream（SECURITY CLEAR，33/33 agents 无 model 声明持续，9 个薄 skill 75 分持续；115 个 NL 文件全部过阈值；多 agent 流水线+文件驱动状态架构；调试三层分离模式值得借鉴） | 2026-08-01 | [2026-08/2026-08-01-jnuyens-gsd-plugin.md](2026-08/2026-08-01-jnuyens-gsd-plugin.md) |
